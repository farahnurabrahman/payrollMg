                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                        <select class="form-control" name="department_id" id="department_id">
                            ...
                            <option value="{{$employee->department->id}}">{{ $item->name }}</option>
                            @endforeach
                        </select>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                        <input value="{{$employee->allowance}}" type="text" class="form-control" id="allowance"
                            name="allowance" placeholder="Allowance" required>
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                        <input value="{{$employee->overtime_hours}}" type="number" class="form-control"
                            id="overtime_hours" name="overtime_hours" placeholder="0.00" required step="0.01" min="0">
                    </div>
                    ...
                    <div class="col-sm-4">
                        <input value="{{$employee->hourly_rate}}" type="text" class="form-control" id="hourly_rate"
                            name="hourly_rate" placeholder="Hourly Rate" required>
                    </div>
